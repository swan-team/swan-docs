...
7.2 为了尽可能地为小程序提供分发服务，您有权利选择将自己的小程序分发到一个或多个宿主下，也有权利不选择不在任何一个宿主上分发您的小程序。而宿主也有权利选择是否接受您的小程序在其app上分发。如果您不做出选择，则默认您同意将小程序分发到全部宿主上。 

宿主，是指智能小程序开源联盟成员合作伙伴有权运营的APP，智能小程序可以运行在该APP上。

...
1. 注册名称规范
    ...
    1. 1.2 命名需注意：
        1. 1.2.1 在智能小程序注册时需要填写智能小程序2~10个字的名称，可以由中文，或中文与数字的组合组成，以表达智能小程序的特征。  
        1. 1.2.2 不能使用特殊符号，繁体字，不能使用空格开始或结尾。  
        1. 1.2.3 名称需保证其所在领域具有唯一识别性和客观性，禁止侵权，禁止具有夸大性、广告性和误导性的名称。  
        1. 1.2.4 名称不得为无意义的数字、字母、特殊字符。   
        1. 1.2.5 不能使用触犯法律法规的名字作为智能小程序名称。  
        1. 1.2.6 不能使用有害于社会主义道德风尚或者有其他不良影响的文字语言作为智能小程序名称。  
        1. 1.2.7 不能使用带有民族歧视性的文字言语作为智能小程序名称。   
        1. 1.2.8 不能使用涉及国家领导人、政治历史事件的名字作为智能小程序名称。  
        1. 1.2.9 不能直接使用城市名、行业领域、等具有概念性概括性的词语作为智能小程序名称。  
        1. 1.2.10 不能使用名称带有广告营销信息的词汇。  
        1. 1.2.11 智能小程序名称不能带有『认证』、『验证』、『核验』、『官方』、『百家』、『百度』等字样。
...
3. 基本信息规范
    ...
    3. 3.6 智能小程序的名称和简介、描述中，不得混有商业化用语、热门应用名称、“国家级”、“最高级”等广告法明令禁止或百度、百家号、熊掌号等使人误解该智能小程序和百度公司或百度关联公司具有关联关系及其他无关的词语。名称不得以电话、邮件、日历等广义归纳类、普遍且不具有识别性的词汇来命名，从而干扰搜索结果。 智能小程序应用名称建议以：品牌词+服务特效（服务地域/服务特色）+产品功能的形式等组合.

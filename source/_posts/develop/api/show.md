...
|<a href="https://smartprogram.baidu.com/docs/develop/api/show_canvas/#canvasContext-moveTo">ccanvasContext.moveTo</a>|把路径移动到画布中的指定点，不创建线条。|
...
|<a href="https://smartprogram.baidu.com/docs/develop/api/show_canvas/#canvasContext-setFontSize">canvasContext.setFontSizet</a>|设置字体的字号|

...
<a href="swanide://fragment/ba3f9ed061cda68b59bea33973caa69c1576045697118" title="在开发者工具中预览效果" target="_self">在开发者工具中预览效果</a>
...
Page({
    ...
    getStorageInfo() {
        ...
        if (!res.errCode || !res.errMsg && !(res instanceof Error)) {
            ...
            console.log('getStorageInfoSync fail', res.errMsg || res.message);
        }
    },
    hasKey() {

...
**解释**： 调起原生半屏内容发布器，并支持开发者配置发布器展示模块。此api版本为单框架，不接入百度服务，即发布的内容无法进入百度app个人主页、无法接入百度互动消息推送。若想自动接入百度服务，请使用[半屏内容发布器带服务版](/develop/extended/component-content/commentpublish/) 。

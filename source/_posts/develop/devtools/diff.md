...
|[swan.compressImage](https://smartprogram.baidu.com/docs/develop/api/media/image_swan-chooseImage/#swan-compressImage/) | 降级支持，提示开发者工具不支持，请使用真机调试 | 
...
|[swan.ai.getVoiceRecognizer](https://smartprogram.baidu.com/docs/develop/api/ai/voice_swan-ai-getVoiceRecognizer/#swan-ai-getVoiceRecognizer/)|降级支持，提示开发者工具不支持，请使用真机调试| 
|[swan.shareFile](https://smartprogram.baidu.com/docs/develop/api/open/share_onShareAppMessage/#swan-shareFile)|降级支持，提示开发者工具不支持，请使用真机调试| 

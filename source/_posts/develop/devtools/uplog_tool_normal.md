...
|版本号|更新时间|更新内容|
|--|--|
|2.4.6|2019.7.26|**New**<p>**·**宿主通过“宿主名_app.json”设置自定义tabbar功能；<p>**·**新增swan.openCommunityEditor（打开原生全屏内容发布器）、swan.closeCommunityEditor（关闭原生全屏内容发布器）；<p>**·**新增[插件开发](https://smartprogram.baidu.com/docs/develop/plugins/survey/)功能;<p>**·**新增小程序集中授权能力。|

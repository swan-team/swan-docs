...
2. 小程序基础功能完善，不影响用户体验。
 ...
 • 视频小程序必须包含但不限于播放/暂停功能、音量调节功能、全屏功能。

 • 需要线上支付的商品服务交易小程序，必须包含完整的支付功能。

 • 音频小程序必须包含播放/暂停功能、音量调节功能。

 • 图片识别文字的小程序要求文字识别结果准确率高。

3. 操作按钮位置和大小不影响使用体验，按钮不能过大、过小，按钮位置不能遮挡正文内容。
...
6. 不能出现空白页面，即点击功能按钮后不能出现空白页面

7. 不能有第三方平台链接跳转 ，即点击链接后不能跳转至其他app

8. 页面加载速度不能过慢  

9. 入驻信息流的小程序页面不能是h5页面       

...
!function(pathname){
    var urlMap = {
        ...
        '/docs/data/guideline/': '/docs/develop/fuctionlist/list/',
        '/docs/design/component/choose/': '/docs/develop/fuctionlist/list/',
        '/docs/design/component/feedback/': '/docs/develop/fuctionlist/list/',
        '/docs/design/component/': '/docs/develop/fuctionlist/list/',
        '/docs/design/component/toptab/': '/docs/develop/fuctionlist/list/',
        '/docs/design/download/': '/docs/develop/fuctionlist/list/',
        '/docs/design/download/load/': '/docs/develop/fuctionlist/list/',
        '/docs/design/index/': '/docs/develop/fuctionlist/list/',
        '/docs/design/principle/clear/': '/docs/develop/fuctionlist/list/',
        '/docs/design/principle/ease/': '/docs/develop/fuctionlist/list/',
        '/docs/design/principle/keynote/': '/docs/develop/fuctionlist/list/',
        '/docs/design/specification/component/': '/docs/develop/fuctionlist/list/',
        '/docs/design/specification/': '/docs/develop/fuctionlist/list/',
        '/docs/design/specification/layout/': '/docs/develop/fuctionlist/list/',
        '/docs/design/specification/pic/': '/docs/develop/fuctionlist/list/',
        '/docs/design/specification/write/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/ai/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/ai_audio/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/ai_audit/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/ai_card/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/ai_classify/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/ai_face/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/ai_image/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/ai_ocr/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/ai_text/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/ai_voice/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/ai_word/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/base_app_event/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/canvas/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/custom_component/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/data/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/debug/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/device/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/device_accelerometer/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/device_battery/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/device_call/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/device_capture/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/device_clipboard/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/device_compass/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/device_direction/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/device_network/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/device_onmemory/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/device_phonecontact/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/device_scan/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/device_screen/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/device_sys/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/device_vibrate/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/ext/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/ext0/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/file/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/file_open/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/file_remove/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/file_save/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/get/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/getExtConfig/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/getExtConfig/swan-getExtConfig/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/getExtConfig/swan-getExtConfigSync/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/getUpdateManager/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/index/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/list/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/location/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/location_get/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/location_map/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/location_open/': '/docs/develop/fuctionlist/list/',
        '/docs/develop/api/media/': '/docs/develop/fuctionlist/list/',
